...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2022 at 06:59 PM
...
INSERT INTO `food_item` (`Serial`, `Food_name`, `Item_code`, `Category`, `Price`) VALUES
(1, 'BBQ Beef Burger', 'bbqb2', 'Burger', 200),
(2, 'BBQ Chicken Burger', 'bbqc2', 'Burger', 200),
(3, 'Beef Cheese Burger', 'bcb1', 'Burger', 220),
(4, 'Chicken Cheese Burger', 'ccb1', 'Burger', 220),
(5, 'Coca Cola', 'dc1', 'Drinks', 35),
(6, 'Fanta', 'df2', 'Drinks', 35),
(7, 'Sprite', 'ds3', 'Drinks', 35),
(8, 'Fresh Water', 'dw4', 'Drinks', 20),
(9, 'French Fry', 'fr1', 'Fries', 80),
(10, 'Onion Ring', 'fr2', 'Fries', 90),
(11, 'Coleslaw', 's1', 'Salad', 50),
(12, 'Cookie Salad', 's2', 'Salad', 115);
...
(111, 'Banani', 'Peter', 1826666, 'pass111', 'peter@gmail.com'),
(123, 'green road', 'ahmed', 123443, '12345', 'ahmed@gmail.com'),
(124, 'green road', 'jack', 123453, '1234345', 'jack@gmail.com'),
(222, 'Dhanmondi', 'Fahim', 1734555, 'pass222', 'fahim@yahoo.com'),
(2020, 'Uttara', 'Redwan', 874975, '0022', 'redwan@yahoo.co'),
(19201013, 'Dhanmondi', 'Rifai', 36863576, '6767', 'rifai@yahaoo.co');
...
--
ALTER TABLE `user`
  MODIFY `USER_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19201014;
...
--
ALTER TABLE `view`
  ADD CONSTRAINT `view_ibfk_1` FOREIGN KEY (`U_ID`) REFERENCES `user` (`USER_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `view_ibfk_2` FOREIGN KEY (`I_CODE`) REFERENCES `food_item` (`Item_code`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
